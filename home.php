...
$sql4 = $koneksi->query("select * from tb_mahasiswa where kode_jurusan ='TI'");
$sql5 = $koneksi->query("select * from tb_mahasiswa where kode_jurusan ='SI'");
$TI=$sql4->num_rows;
$SI=$sql5->num_rows;
...
<marquee>Selamat Datang di Sistem Informasi Akademik STMIK SZ NW ANJANI LOMBOK TIMUR</marquee>
  ...
  <script type="text/javascript">
    ...
    function drawChart() {
      var data = google.visualization.arrayToDataTable([
        ...
        ["Teknik Informatika", <?php echo $TI; ?>, "blue"],
        ["Sistem Informasi", <?php echo $SI; ?>, "red"],
